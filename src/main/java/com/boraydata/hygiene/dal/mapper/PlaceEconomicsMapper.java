...
@Mapper
public interface PlaceEconomicsMapper {

    @Select("select id, place_name placeName, place_id placeId " +
            "from hygiene.place_economics_info " +
    ...
    @Insert("insert info hygiene.place_economics_info(place_name, place_id, data) " +
    ...
    @Update("update hygiene.place_economics_info " +
